      ...
      <div className="dashboard-root">
        ...
        <div className="page-nav">
          <div className="page-nav-inner">
            ...
            {isAdmin && <a href="https://docs.google.com/presentation/d/1JvySy1kYDttbP32xyib5tkw7Wr0aYEyZBcW8-TsS5v8/edit?slide=id.p1#slide=id.p1" target="_blank" rel="noopener noreferrer" className="page-nav-btn" style={{ background: 'rgba(236,72,153,.12)', borderColor: 'rgba(236,72,153,.3)', color: '#f472b6' }}>📊 25/26 KPI Reports ↗</a>}
          </div>
        </div>
          ...
          {activeSection === 'overview' && (
            <section className="dash-section">
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px', marginTop: '24px' }}>
                ...
                <div className="tc" style={{ padding: '24px', height: '350px', position: 'relative' }}>
                  <div style={{ fontSize: '12px', fontWeight: 800, color: '#64748b', textTransform: 'uppercase', marginBottom: '20px' }}>📊 TEAM PERFORMANCE (CURRENT MONTH)</div>
                  <div style={{ height: '260px' }}>
                    <Bar 
                      data={{
                        labels: Object.keys(teamSummaries),
                        datasets: [{
                          label: 'Revenue',
                          data: Object.values(teamSummaries).map(t => t.deliveredAmt),
                          backgroundColor: [
                            'rgba(16, 185, 129, 0.6)',
                            'rgba(59, 130, 246, 0.6)',
                            'rgba(139, 92, 246, 0.6)',
